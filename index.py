...
menu_category = ["Fast Food","Tea and Coffee", "Beverages", "Starters", "Main Food", "Dessert"]

menu_category_dict = {"Tea and Coffee": "1 Tea.txt", "Beverages": "2 Beverages.txt",
                      "Fast Food": "3 Fast Food.txt",
                      "Starters": "4 Starters.txt", "Main Food": "5 Main Food.txt",
...
root.title("Rethabile Hotel Billing System")

style_button = ttk.Style()
style_button.configure("TButton", font=("arial", 10, "bold"),
                       background="gold")

title_frame = Frame(root, bd=8, bg="gold", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")

title_label = Label(title_frame, text="Rethabile's Hotel Billing System",
                    font=("arial", 22, "bold"), bg="sky blue", fg="red", pady=8)
title_label.pack()
...
customer_name_label = Label(customer_frame, text="Name",
                            font=("calibri", 12, "bold"), bg="lightblue", fg="blue")
customer_name_label.grid(row=0, column=0)

customerName = StringVar()
customerName.set("")
customer_name_entry = Entry(customer_frame, width=20, font="calibri 12", bd=5,
...
customer_contact_label = Label(customer_frame, text="Contact",
                               font=("calibri", 15, "bold"), bg="lightblue", fg="blue")
customer_contact_label.grid(row=0, column=2)

customerContact = StringVar()
customerContact.set("")
customer_contact_entry = Entry(customer_frame, width=20, font="calibri 15", bd=5,
...
menu_frame.place(x=0, y=125, height=600, width=680)
...
itemName = StringVar()
itemName.set("")
item_name = Entry(item_frame2, font="calibri 12", textvariable=itemName, state=DISABLED, width=25)
...
itemRate = StringVar()
itemRate.set("")
item_rate = Entry(item_frame2, font="calibri 12", textvariable=itemRate, state=DISABLED, width=10)
...
itemQuantity.set("")
item_quantity = Entry(item_frame2, font="calibri 12", textvariable=itemQuantity, width=10)
...
remove_button = ttk.Button(item_frame3, text="Remove"
...
order_tabel.column("rate", width=80, anchor='center', stretch=NO)
order_tabel.column("quantity", width=80, anchor='center', stretch=NO)
order_tabel.column("price", width=80, anchor='center', stretch=NO)
